...
typedef dadosfila TipoDadoFila; //Define o tipo de dado que será armazenado na Fila
...
bool Fila_Desenfileirar(TipoDadoFila &Elemento);
...
bool Fila_Frente(TipoDadoFila &Elemento);
